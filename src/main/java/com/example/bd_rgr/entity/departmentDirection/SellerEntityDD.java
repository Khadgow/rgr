...
public class SellerEntityDD {
    ...
    @JsonBackReference
    private DepartmentEntityDD department;
    ...
    public DepartmentEntityDD getDepartment() {
        return department;
    }

    public void setDepartment(DepartmentEntityDD department) {
