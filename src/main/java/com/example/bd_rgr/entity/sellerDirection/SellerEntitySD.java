...
public class SellerEntitySD {
    ...
    private DepartmentEntitySD department;
    ...
    public DepartmentEntitySD getDepartment() {
        return department;
    }

    public void setDepartment(DepartmentEntitySD department) {
