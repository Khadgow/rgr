...
public class SellerEntityRD {
    ...
    private DepartmentEntityRD department;
    ...
    public DepartmentEntityRD getDepartment() {
        return department;
    }

    public void setDepartment(DepartmentEntityRD department) {
